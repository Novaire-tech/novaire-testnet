...
export function YieldAnalytics() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        <CardWaveDecoration />
        <h3 className="relative z-10 text-lg font-semibold text-white mb-6">Portfolio Allocation</h3>
      ...
      >
        <CardWaveDecoration />
        <h3 className="relative z-10 text-lg font-semibold text-white mb-6">Yield Sources</h3>
        <div className="relative z-10 flex flex-col gap-4">
          <div className="p-4 rounded-xl bg-white/5 border border-white/10">
            ...
            <div className="w-full bg-white/5 rounded-full h-1.5">
              <div className="bg-[#BEB7A7] h-1.5 rounded-full" style={{ width: '80%' }}></div>
            </div>
          </div>
