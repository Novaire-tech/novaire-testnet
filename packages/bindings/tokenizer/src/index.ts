...
export const networks = {
  testnet: {
    ...
    contractId: "CAERQIJESV5K3K75WKB6W2UZGEMRE7SZCHZBGH766PQFDQ5GGZ57GB5E",
  }
} as const

export type DataKey = {tag: "Admin", values: void} | {tag: "Vault", values: void} | {tag: "PtToken", values: void} | {tag: "YtToken", values: void} | {tag: "SyWrapper", values: void} | {tag: "MaturityLedger", values: void} | {tag: "EpochId", values: void} | {tag: "EpochStartIndex", values: void} | {tag: "TotalPtMinted", values: void} | {tag: "SettlementExchangeRate", values: void} | {tag: "MaturityEngine", values: void} | {tag: "MaturityEngineEpochId", values: void} | {tag: "LastRecordedSurplus", values: void};
...
export interface Client {
   ...
   */
  initialize: ({admin, vault, pt_token, yt_token, sy_wrapper, maturity_ledger, maturity_engine, maturity_engine_epoch_id}: {admin: string, vault: string, pt_token: string, yt_token: string, sy_wrapper: string, maturity_ledger: u32, maturity_engine: string, maturity_engine_epoch_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAHdmVyc2lvbgAAAAAAAAAAAQAAAAQ=",
        ...
        "",
        "",
        ...
        "" ]),
      options
    )
  }
